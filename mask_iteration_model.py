...
from redress.geospatial.gdal_ops import (build_poly_from_geojson,
                                                resample_dataset,
                                                write_xarray_dset,write_xarray)
...
osmd.init_DEM(outputs_folder,inputs_folder, demfile,"gdal_reader")# , "large.geojson")
############################SAT3#######################################################
...
#SENTINEL 2 
#date="20180425"
#s3_str = inputs_folder+"SAT2/L1C/S2A_MSIL1C_20180204T103221_N0206_R108_T31TGL_20180204T124014.SAFE/GRANULE/L1C_T31TGL_A013690_20180204T103532/IMG_DATA/"
...
#    
##    osmd.dem.bands["slope"].values[5,57]*(180/np.pi)=10.225850159283148
#    y=10#36
#    x=5       
...
#    fplot.PlotDMPixRADIANCE(outputs_folder,"ombré",osmd,iterOptim,x,y)
        ...
        write_xarray(osmd.model.a,  outputs_folder+"%s/a%s.tiff" %(osmd.sat.date,i),2154, osmd.sat.geotransform)  
        write_xarray(osmd.model.rmse,  outputs_folder+"%s/rmse%s.tiff" %(osmd.sat.date,i),2154, osmd.sat.geotransform)  
#        ax=xr.Dataset()
#        ax["a"]=xr.DataArray(osmd.model.a,dims=['y', 'x'],coords=osmd.model.topo_bands.coords)
#        
#        write_xarray_dset(ax, outputs_folder+"%s/a%s.tiff" %(osmd.sat.date,i), 
#                      2154, osmd.sat.geotransform)
#        
#        rmsex=xr.Dataset()  
#        
...
#        
#        write_xarray_dset(rmsex, outputs_folder+"%s/rmse%s.tiff" %(osmd.sat.date,i), 
#                      2154, osmd.sat.geotransform)
        ...
        if date=='20180213' :
            ...
            dateSAT2="20180415"
            fplot.CompareSnowMask(inputs_folder,dateSAT2,outputs_folder, osmd, True,iterOptim)
            fplot.ProjectSnowMaskSAT2(inputs_folder,dateSAT2,outputs_folder, osmd,iterOptim)
            dateSAT2="20180420"
            fplot.CompareSnowMask(inputs_folder,dateSAT2,outputs_folder, osmd, True,iterOptim)
            fplot.ProjectSnowMaskSAT2(inputs_folder,dateSAT2,outputs_folder, osmd,iterOptim)
